    ...
    class Program
    {
        static void Main()
        {
            ...
            var result = goods
                ...
                .Join(prices, t => new {t.o.VendorCode, t.o.Name}, p => new {p.VendorCode, p.Name},
                    (t, p) => new {t, p})
                .Join(customers, t => t.t.o.Code, c => c.Code,
                    (t, c) => new {t.t.o.Name, t.t.g.Country, c.Year, t.p.Price, c.Code})
